...
//  bf
//
//  Created by Ever Eduardo Velazco Romero on 11/14/17.
//  Copyright © 2017 ANSoft. All rights reserved.
//
// Thanks to https://github.com/mtynior/ColorizeSwift
//
//  ColorizeSwift.swift
//  ColorizeSwift
//
...
/// TerminalStyleCode
/// Typealias
/// A tuple to hold color strings.
/// Pretty useful tool to handle colorization.
///
...
/// TerminalStyle
/// Structure
/// The basic structure for building every
/// single color on the terminal.
///
...
/// Extension
/// x :: () -> String
/// Useful function for terminal colors
///
...
extension String {
    ...
    /// Applying colors function
    /// foregroundColor :: TerminalColor -> String
    ...
    /// backgroundColor :: TerminlaColor -> String
    ...
    /// colorize :: TerminalColor -> TerminalColor -> String
    ...
    /// applyStyle :: TerminalColor -> String
...
///
/// A full description of every color can be found here:
...
/// TerminalColor
/// ADT - Sum Type
/// It representes 256 possible terminal colors
///
...
public enum TerminalColor: UInt8 {
    ...
    ///
    /// foregroundStyleCode :: () -> TerminalStyleCode
    /// - return: The TerminalStyleColor representation of a TerminalColor
    ///
    ...
    ///
    /// backgroundStyleCode :: () -> TerminalStyleCode
    /// - return: The TerminalStyleColor representation of a TerminalColor
    ///
